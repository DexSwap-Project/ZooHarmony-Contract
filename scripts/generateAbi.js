...
const abiFiles = [
    [
        '../build/contracts/NFTFactoryDelegate.json',
    ],
    [
        '../build/contracts/MarketplaceDelegate.json',
    ],
    [
        '../build/contracts/ZooKeeperFarming.json',
    ],
    [
        '../build/contracts/ZooNFT.json',
    ],
    [
        '../build/contracts/ZooHarmony.json',
    ],
];
